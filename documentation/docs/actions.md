...
Actions are the most useful things in GoMS and we will see that everything you have done in Goms was as action itself.
...
Goms includes the [otto js engine](https://github.com/robertkrimen/otto). An exclamation mark tell goms to evaluate the rest of the string as Javascript.
