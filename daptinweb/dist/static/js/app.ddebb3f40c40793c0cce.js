...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jsonapi__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__actionmanager__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__appconfig__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_auth__ = __webpack_require__(17);
...
var WorldManager = function WorldManager() {
  ...
  that.startObjectTrack = function (objType, objRefId, stateMachineRefId) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_axios___default()({
      url: __WEBPACK_IMPORTED_MODULE_5__appconfig__["a" /* default */].apiRoot + "/track/start/" + stateMachineRefId,
      method: "POST",
      data: {
        typeName: objType,
      ...
      headers: {
        "Authorization": "Bearer " + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_auth__["d" /* getToken */])()
      }
    });
  };

  that.trackObjectEvent = function (typeName, stateMachineRefId, eventName) {
    console.log("change object track", __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_auth__["d" /* getToken */])());
    return __WEBPACK_IMPORTED_MODULE_2_axios___default()({
      url: __WEBPACK_IMPORTED_MODULE_5__appconfig__["a" /* default */].apiRoot + "/track/event/" + typeName + "/" + stateMachineRefId + "/" + eventName,
      method: "POST",
      headers: {
        "Authorization": "Bearer " + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_auth__["d" /* getToken */])()
      }
  ...
  that.getColumnKeys = function (typeName, callback) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_axios___default()(__WEBPACK_IMPORTED_MODULE_5__appconfig__["a" /* default */].apiRoot + '/jsmodel/' + typeName + ".js", {
      headers: {
        "Authorization": "Bearer " + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_auth__["d" /* getToken */])()
      }
    }).then(function (r) {
      if (r.status === 200) {
        ...
        if (r.Actions.length > 0) {
          __WEBPACK_IMPORTED_MODULE_4__actionmanager__["a" /* default */].addAllActions(r.Actions);
        }
  ...
  __WEBPACK_IMPORTED_MODULE_2_axios___default()(__WEBPACK_IMPORTED_MODULE_5__appconfig__["a" /* default */].apiRoot + "/meta?query=column_types", {
    headers: {
      "Authorization": "Bearer " + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_auth__["d" /* getToken */])(),
  ...
  __WEBPACK_IMPORTED_MODULE_2_axios___default()({
    url: __WEBPACK_IMPORTED_MODULE_5__appconfig__["a" /* default */].apiRoot + '/recline_model'
  }).then(function (res) {
  ...
  __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("image.png|jpg|jpeg|gif|tiff", {
    "__type": "value",
    "contents": "value",
    "name": "value",
    "reference_id": "value",
  ...
  __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("image.png|jpg", {
    "__type": "value",
    "contents": "value",
    "name": "value",
    "reference_id": "value",
  ...
  __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("image.jpg|png", {
    "__type": "value",
    "contents": "value",
    "name": "value",
    "reference_id": "value",
  ...
  __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("image.png", {
    "__type": "value",
    "contents": "value",
    "name": "value",
    "reference_id": "value",
  ...
  __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("image.gif", {
    "__type": "value",
    "contents": "value",
    "name": "value",
    "reference_id": "value",
  ...
  that.loadModel = function (modelName) {
    var promise = new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      ...
      that.modelLoader(modelName, function (columnKeys) {
        __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define(modelName, that.GetJsonApiModel(columnKeys.ColumnModel));
        resolve();
      });
    });
  ...
  that.loadModels = function () {
    ...
    var promise = new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      that.modelLoader("user_account", function (columnKeys) {
        __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("user_account", that.GetJsonApiModel(columnKeys.ColumnModel));
        that.modelLoader("usergroup", function (columnKeys) {
          __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("usergroup", that.GetJsonApiModel(columnKeys.ColumnModel));

          that.modelLoader("world", function (columnKeys) {
            that.modelLoader("stream", function (streamKeys) {

              __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("world", that.GetJsonApiModel(columnKeys.ColumnModel));
              __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define("stream", that.GetJsonApiModel(streamKeys.ColumnModel));

              that.systemActions = columnKeys.Actions;

              __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].findAll('world', {
                page: { number: 1, size: 500 }
              }).then(function (res) {
                res = res.data;
                that.worlds = res;
                __WEBPACK_IMPORTED_MODULE_7__store__["a" /* default */].commit("SET_WORLDS", res);
                ...
                for (var t = 0; t < res.length; t++) {
                  (function (typeName) {
                    that.modelLoader(typeName, function (model) {
                      ...
                      __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].define(typeName, that.GetJsonApiModel(model.ColumnModel));
                    });
                  })(res[t].table_name);
                }
              });

              __WEBPACK_IMPORTED_MODULE_3__jsonapi__["a" /* default */].findAll('stream', {
                page: { number: 1, size: 500 }
              }).then(function (res) {
                res = res.data;
                that.streams = res;
                __WEBPACK_IMPORTED_MODULE_7__store__["a" /* default */].commit("SET_STREAMS", res);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_auth__ = __webpack_require__(17);
...
var ActionManager = function ActionManager() {
  ...
  this.saveByteArray = function (downloadData) {
    ...
    var blob = b64toBlob(downloadData.content, downloadData.contentType);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_devour_client__ = __webpack_require__(387);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_auth__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_js_cookie__ = __webpack_require__(464);
...
var ConfigManager = function ConfigManager() {
  ...
  this.getConfig = function (name) {
    return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      __WEBPACK_IMPORTED_MODULE_2_axios___default()({
        url: __WEBPACK_IMPORTED_MODULE_1__appconfig__["a" /* default */].apiRoot + "/_config/backend/" + name,
        method: "GET",
        headers: {
  ...
  this.getAllConfig = function () {
    var p = new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      __WEBPACK_IMPORTED_MODULE_2_axios___default()({
        url: __WEBPACK_IMPORTED_MODULE_1__appconfig__["a" /* default */].apiRoot + "/_config",
        method: "GET",
        headers: {
          "Authorization": "Bearer " + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_auth__["d" /* getToken */])()
        }
...
/* harmony default export */ __webpack_exports__["a"] = (new ConfigManager());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__state__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutations__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__getters__ = __webpack_require__(290);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_element_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_vuetable__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_daptable_DaptableView_vue__ = __webpack_require__(630);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_vuetable_components_Vuecard_vue__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_detailrow_DetailedRow_vue__ = __webpack_require__(632);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_modelform_ModelForm_vue__ = __webpack_require__(639);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_vuetable_components_VuetablePagination_vue__ = __webpack_require__(200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_detailrow_CustomActions_vue__ = __webpack_require__(631);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_tableview_TableView_vue__ = __webpack_require__(642);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_selectoneormore_SelectOneOrMore_vue__ = __webpack_require__(641);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_listview_ListView_vue__ = __webpack_require__(638);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_actionview_ActionView_vue__ = __webpack_require__(629);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_reclineview_ReclineView_vue__ = __webpack_require__(640);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_element_ui_lib_locale_lang_en__ = __webpack_require__(422);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_element_ui_lib_theme_default_index_css__ = __webpack_require__(436);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_tether_shepherd_dist_css_shepherd_theme_dark_css__ = __webpack_require__(442);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_vuetable_vuetable_css__ = __webpack_require__(443);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_fields_FileUpload_vue__ = __webpack_require__(636);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_fields_PermissionField_vue__ = __webpack_require__(637);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_fields_FileJsonEditor_vue__ = __webpack_require__(635);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_fields_FancyCheckBox_vue__ = __webpack_require__(634);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_fields_DateSelect_vue__ = __webpack_require__(633);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Dash_vue__ = __webpack_require__(615);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Login_vue__ = __webpack_require__(198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_404_vue__ = __webpack_require__(611);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_InstanceView__ = __webpack_require__(618);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_EntityView__ = __webpack_require__(616);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_NewItem__ = __webpack_require__(620);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_RelationView__ = __webpack_require__(622);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Admin__ = __webpack_require__(613);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_SignIn__ = __webpack_require__(625);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Login2FA__ = __webpack_require__(619);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Login2FA___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__components_Login2FA__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_SignedIn__ = __webpack_require__(628);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_SignedIn___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__components_SignedIn__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_SignOut__ = __webpack_require__(626);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_SignOut___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__components_SignOut__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_OauthResponse__ = __webpack_require__(621);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_OauthResponse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__components_OauthResponse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_SignUp__ = __webpack_require__(627);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_SignUp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13__components_SignUp__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_Action__ = __webpack_require__(612);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_Action___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14__components_Action__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Home__ = __webpack_require__(617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Home___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15__components_Home__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_views_Dashboard_vue__ = __webpack_require__(644);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_views_Dashboard_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16__components_views_Dashboard_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_views_AllInOne_vue__ = __webpack_require__(643);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_views_AllInOne_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17__components_views_AllInOne_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_ConfigurationEditor__ = __webpack_require__(614);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_ConfigurationEditor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_18__components_ConfigurationEditor__);
...
var routes = [{
  ...
  name: 'SignIn2FA',
  path: '/auth/signin2fa',
  component: __WEBPACK_IMPORTED_MODULE_9__components_Login2FA___default.a
}, {
  name: 'SignedIn',
  path: '/auth/signedin',
  component: __WEBPACK_IMPORTED_MODULE_10__components_SignedIn___default.a
}, {
  name: 'SignUp',
  path: '/auth/signup',
  component: __WEBPACK_IMPORTED_MODULE_13__components_SignUp___default.a
}, {
  name: 'SignOut',
  path: '/auth/signout',
  component: __WEBPACK_IMPORTED_MODULE_11__components_SignOut___default.a
}, {
  name: "OauthResponse",
  path: '/oauth/response',
  component: __WEBPACK_IMPORTED_MODULE_12__components_OauthResponse___default.a
}, {
  path: '/',
  ...
  children: [{
    path: '',
    name: 'Dashboard',
    component: __WEBPACK_IMPORTED_MODULE_16__components_views_Dashboard_vue___default.a
  }, {
    path: '/all',
    name: 'AllInOne',
    component: __WEBPACK_IMPORTED_MODULE_17__components_views_AllInOne_vue___default.a
  }, {
    path: '/act/:tablename/:actionname',
    name: 'Action',
    component: __WEBPACK_IMPORTED_MODULE_14__components_Action___default.a
  }, {
    path: '/',
    ...
    children: [{
      ...
      name: 'Configuration',
      component: __WEBPACK_IMPORTED_MODULE_18__components_ConfigurationEditor___default.a
    }, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config__ = __webpack_require__(206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue__ = __webpack_require__(645);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Vuecard_vue__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_VuetablePagination_vue__ = __webpack_require__(200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_VuetablePaginationDropdown_vue__ = __webpack_require__(646);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_VuetablePaginationInfo_vue__ = __webpack_require__(647);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_router__ = __webpack_require__(212);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuex_router_sync__ = __webpack_require__(213);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_main__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__plugins_worldmanager__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__plugins_jsonapi__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__plugins_actionmanager__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__plugins_axios__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_filter__ = __webpack_require__(210);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__routes__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__store__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_App_vue__ = __webpack_require__(211);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  setStreams: function setStreams(_ref3, streams) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_jsonapi__ = __webpack_require__(13);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  selectedSubTable: function selectedSubTable(state) {
    return state.selectedSubTable;
  },
  showAddEdit: function showAddEdit(state) {
    return state.showAddEdit;
  },
  visibleWorlds: function visibleWorlds(state) {
    var filtered = state.worlds.filter(function (w, r) {
      if (!state.selectedInstanceReferenceId) {
        return w.is_top_level == 1 && w.is_hidden == 0;
      } else {
        var model = __WEBPACK_IMPORTED_MODULE_2__plugins_jsonapi__["a" /* default */].modelFor(w.table_name);
        var attrs = model["attributes"];
        var keys = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(attrs);
  ...
  preferredLanguage: function preferredLanguage(state) {
    var lang = localStorage.getItem("LANGUAGE");
    if (!lang) {
  ...
  languages: function languages() {
    return [{ "label": "Abkhazian ", "id": "ab" }, { "label": "Afar ", "id": "aa" }, { "label": "Afrikaans ", "id": "af" }, { "label": "Akan ", "id": "ak" }, { "label": "Albanian ", "id": "sq" }, { "label": "Amharic ", "id": "am" }, { "label": "Arabic ", "id": "ar" }, { "label": "Aragonese ", "id": "an" }, { "label": "Armenian ", "id": "hy" }, { "label": "Assamese ", "id": "as" }, { "label": "Avaric ", "id": "av" }, { "label": "Avestan ", "id": "ae" }, { "label": "Aymara ", "id": "ay" }, { "label": "Azerbaijani ", "id": "az" }, { "label": "Bambara ", "id": "bm" }, { "label": "Bashkir ", "id": "ba" }, { "label": "Basque ", "id": "eu" }, { "label": "Belarusian ", "id": "be" }, { "label": "Bengali (Bangla) ", "id": "bn" }, { "label": "Bihari ", "id": "bh" }, { "label": "Bislama ", "id": "bi" }, { "label": "Bosnian ", "id": "bs" }, { "label": "Breton ", "id": "br" }, { "label": "Bulgarian ", "id": "bg" }, { "label": "Burmese ", "id": "my" }, { "label": "Catalan ", "id": "ca" }, { "label": "Chamorro ", "id": "ch" }, { "label": "Chechen ", "id": "ce" }, { "label": "Chichewa, Chewa, Nyanja ", "id": "ny" }, { "label": "Chinese ", "id": "zh" }, { "label": "Chinese (Simplified) ", "id": "zh-Hans" }, { "label": "Chinese (Traditional) ", "id": "zh-Hant" }, { "label": "Chuvash ", "id": "cv" }, { "label": "Cornish ", "id": "kw" }, { "label": "Corsican ", "id": "co" }, { "label": "Cree ", "id": "cr" }, { "label": "Croatian ", "id": "hr" }, { "label": "Czech ", "id": "cs" }, { "label": "Danish ", "id": "da" }, { "label": "Divehi, Dhivehi, Maldivian ", "id": "dv" }, { "label": "Dutch ", "id": "nl" }, { "label": "Dzongkha ", "id": "dz" }, { "label": "English ", "id": "en" }, { "label": "Esperanto ", "id": "eo" }, { "label": "Estonian ", "id": "et" }, { "label": "Ewe ", "id": "ee" }, { "label": "Faroese ", "id": "fo" }, { "label": "Fijian ", "id": "fj" }, { "label": "Finnish ", "id": "fi" }, { "label": "French ", "id": "fr" }, { "label": "Fula, Fulah, Pulaar, Pular ", "id": "ff" }, { "label": "Galician ", "id": "gl" }, { "label": "Gaelic (Scottish) ", "id": "gd" }, { "label": "Gaelic (Manx) ", "id": "gv" }, { "label": "Georgian ", "id": "ka" }, { "label": "German ", "id": "de" }, { "label": "Greek ", "id": "el" }, { "label": "Greenlandic ", "id": "kl" }, { "label": "Guarani ", "id": "gn" }, { "label": "Gujarati ", "id": "gu" }, { "label": "Haitian Creole ", "id": "ht" }, { "label": "Hausa ", "id": "ha" }, { "label": "Hebrew ", "id": "he" }, { "label": "Herero ", "id": "hz" }, { "label": "Hindi ", "id": "hi" }, { "label": "Hiri Motu ", "id": "ho" }, { "label": "Hungarian ", "id": "hu" }, { "label": "Icelandic ", "id": "is" }, { "label": "Ido ", "id": "io" }, { "label": "Igbo ", "id": "ig" }, { "label": "Indonesian ", "id": "id, in" }, { "label": "Interlingua ", "id": "ia" }, { "label": "Interlingue ", "id": "ie" }, { "label": "Inuktitut ", "id": "iu" }, { "label": "Inupiak ", "id": "ik" }, { "label": "Irish ", "id": "ga" }, { "label": "Italian ", "id": "it" }, { "label": "Japanese ", "id": "ja" }, { "label": "Javanese ", "id": "jv" }, { "label": "Kalaallisut, Greenlandic ", "id": "kl" }, { "label": "Kannada ", "id": "kn" }, { "label": "Kanuri ", "id": "kr" }, { "label": "Kashmiri ", "id": "ks" }, { "label": "Kazakh ", "id": "kk" }, { "label": "Khmer ", "id": "km" }, { "label": "Kikuyu ", "id": "ki" }, { "label": "Kinyarwanda (Rwanda) ", "id": "rw" }, { "label": "Kirundi ", "id": "rn" }, { "label": "Kyrgyz ", "id": "ky" }, { "label": "Komi ", "id": "kv" }, { "label": "Kongo ", "id": "kg" }, { "label": "Korean ", "id": "ko" }, { "label": "Kurdish ", "id": "ku" }, { "label": "Kwanyama ", "id": "kj" }, { "label": "Lao ", "id": "lo" }, { "label": "Latin ", "id": "la" }, { "label": "Latvian (Lettish) ", "id": "lv" }, { "label": "Limburgish ( Limburger) ", "id": "li" }, { "label": "Lingala ", "id": "ln" }, { "label": "Lithuanian ", "id": "lt" }, { "label": "Luga-Katanga ", "id": "lu" }, { "label": "Luganda, Ganda ", "id": "lg" }, { "label": "Luxembourgish ", "id": "lb" }, { "label": "Manx ", "id": "gv" }, { "label": "Macedonian ", "id": "mk" }, { "label": "Malagasy ", "id": "mg" }, { "label": "Malay ", "id": "ms" }, { "label": "Malayalam ", "id": "ml" }, { "label": "Maltese ", "id": "mt" }, { "label": "Maori ", "id": "mi" }, { "label": "Marathi ", "id": "mr" }, { "label": "Marshallese ", "id": "mh" }, { "label": "Moldavian ", "id": "mo" }, { "label": "Mongolian ", "id": "mn" }, { "label": "Nauru ", "id": "na" }, { "label": "Navajo ", "id": "nv" }, { "label": "Ndonga ", "id": "ng" }, { "label": "Northern Ndebele ", "id": "nd" }, { "label": "Nepali ", "id": "ne" }, { "label": "Norwegian ", "id": "no" }, { "label": "Norwegian bokmål ", "id": "nb" }, { "label": "Norwegian nynorsk ", "id": "nn" }, { "label": "Nuosu ", "id": "ii" }, { "label": "Occitan ", "id": "oc" }, { "label": "Ojibwe ", "id": "oj" }, { "label": "Old Church Slavonic, Old Bulgarian ", "id": "cu" }, { "label": "Oriya ", "id": "or" }, { "label": "Oromo (Afaan Oromo) ", "id": "om" }, { "label": "Ossetian ", "id": "os" }, { "label": "Pāli ", "id": "pi" }, { "label": "Pashto, Pushto ", "id": "ps" }, { "label": "Persian (Farsi) ", "id": "fa" }, { "label": "Polish ", "id": "pl" }, { "label": "Portuguese ", "id": "pt" }, { "label": "Punjabi (Eastern) ", "id": "pa" }, { "label": "Quechua ", "id": "qu" }, { "label": "Romansh ", "id": "rm" }, { "label": "Romanian ", "id": "ro" }, { "label": "Russian ", "id": "ru" }, { "label": "Sami ", "id": "se" }, { "label": "Samoan ", "id": "sm" }, { "label": "Sango ", "id": "sg" }, { "label": "Sanskrit ", "id": "sa" }, { "label": "Serbian ", "id": "sr" }, { "label": "Serbo-Croatian ", "id": "sh" }, { "label": "Sesotho ", "id": "st" }, { "label": "Setswana ", "id": "tn" }, { "label": "Shona ", "id": "sn" }, { "label": "Sichuan Yi ", "id": "ii" }, { "label": "Sindhi ", "id": "sd" }, { "label": "Sinhalese ", "id": "si" }, { "label": "Siswati ", "id": "ss" }, { "label": "Slovak ", "id": "sk" }, { "label": "Slovenian ", "id": "sl" }, { "label": "Somali ", "id": "so" }, { "label": "Southern Ndebele ", "id": "nr" }, { "label": "Spanish ", "id": "es" }, { "label": "Sundanese ", "id": "su" }, { "label": "Swahili (Kiswahili) ", "id": "sw" }, { "label": "Swati ", "id": "ss" }, { "label": "Swedish ", "id": "sv" }, { "label": "Tagalog ", "id": "tl" }, { "label": "Tahitian ", "id": "ty" }, { "label": "Tajik ", "id": "tg" }, { "label": "Tamil ", "id": "ta" }, { "label": "Tatar ", "id": "tt" }, { "label": "Telugu ", "id": "te" }, { "label": "Thai ", "id": "th" }, { "label": "Tibetan ", "id": "bo" }, { "label": "Tigrinya ", "id": "ti" }, { "label": "Tonga ", "id": "to" }, { "label": "Tsonga ", "id": "ts" }, { "label": "Turkish ", "id": "tr" }, { "label": "Turkmen ", "id": "tk" }, { "label": "Twi ", "id": "tw" }, { "label": "Uyghur ", "id": "ug" }, { "label": "Ukrainian ", "id": "uk" }, { "label": "Urdu ", "id": "ur" }, { "label": "Uzbek ", "id": "uz" }, { "label": "Venda ", "id": "ve" }, { "label": "Vietnamese ", "id": "vi" }, { "label": "Volapük ", "id": "vo" }, { "label": "Wallon ", "id": "wa" }, { "label": "Welsh ", "id": "cy" }, { "label": "Wolof ", "id": "wo" }, { "label": "Western Frisian ", "id": "fy" }, { "label": "Xhosa ", "id": "xh" }, { "label": "Yiddish ", "id": "yi, ji" }, { "label": "Yoruba ", "id": "yo" }, { "label": "Zhuang, Chuang ", "id": "za" }, { "label": "Zulu ", "id": "zu" }];
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_actionmanager__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_jsonapi__ = __webpack_require__(13);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_auth__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_worldmanager__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_actionmanager__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_configmanager__ = __webpack_require__(52);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    saveChanges: function saveChanges() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a.all(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(this.changed).map(function (item) {
        return __WEBPACK_IMPORTED_MODULE_2__plugins_configmanager__["a" /* default */].setConfig(item, that.changed[item]);
      })).then(function (res) {
        console.log("saved all settings ");
        that.showSave = false;
        __WEBPACK_IMPORTED_MODULE_2__plugins_configmanager__["a" /* default */].getAllConfig().then(function (data) {
          that.settings = data;
        });
      }).catch(function (err) {
    ...
    showSaveButton: function showSaveButton(itemName, value) {
      if (value === true) {
        value = "true";
      } else if (value === false) {
        value = "false";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config__ = __webpack_require__(206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Sidebar__ = __webpack_require__(623);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_tether_shepherd__ = __webpack_require__(603);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(["visibleWorlds", 'isAuthenticated', 'user', "languages", "preferredLanguage"]), {
        demo: function demo() {
            return {
    ...
    }, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuex__["d" /* mapActions */])(["setQuery", "setLanguage"]), {
        setQueryString: function setQueryString(query) {
            console.log("set query", query);
            this.setQuery(query);
            return false;
        },
        setPreferredLanguage: function setPreferredLanguage() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_jsonapi__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__plugins_actionmanager__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_configmanager__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_actionmanager__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plugins_worldmanager__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_jsonapi__ = __webpack_require__(13);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_vuex__["b" /* mapState */])(['worlds']), {
  ...
  methods: {
    ...
    createEntity: function createEntity() {
      ...
      var fileContent = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()({
        Tables: [{
      ...
      __WEBPACK_IMPORTED_MODULE_5__plugins_actionmanager__["a" /* default */].doAction("world", "upload_system_schema", postData);
    }
  },
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    ...
    var that = this;
    that.columnTypes = __WEBPACK_IMPORTED_MODULE_3__plugins_worldmanager__["a" /* default */].getColumnFieldTypes();
    var query = this.$route.query;
    if (query && query.table) {
      __WEBPACK_IMPORTED_MODULE_3__plugins_worldmanager__["a" /* default */].getColumnKeys(query.table, function (columns) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__plugins_configmanager__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_actionmanager__ = __webpack_require__(9);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SidebarMenu__ = __webpack_require__(624);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_kingtable__ = __webpack_require__(519);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_kingtable_utils__ = __webpack_require__(533);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue2_ace__ = __webpack_require__(692);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_brace_theme_chrome__ = __webpack_require__(341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_brace_mode_markdown__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__plugins_jsonapi__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jsoneditor__ = __webpack_require__(467);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_underscore__ = __webpack_require__(608);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_form_generator__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_form_generator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_form_generator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__plugins_jsonapi__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_element_ui__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_element_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_element_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_x_data_spreadsheet__ = __webpack_require__(736);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jexcel__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jexcel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_jexcel__);
        ...
        try {
          if (that.viewMode == "card") {
            ...
            that.jsonApi.get({
              ...
              for (var i = 0; i < rows.length; i++) {
                ...
                for (var j in headers) {
                  ...
                  if (rows[i][column] instanceof Array) {
                    ...
                    row.push(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(rows[i][column]));
                  } else {
              ...
              var spreadsheet = __WEBPACK_IMPORTED_MODULE_4_jexcel___default()(that.$refs.tableViewDiv, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plugins_jsonapi__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plugins_actionmanager__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    return str.replace(/[-_]/g, " ").split(' ').map(function (w) {
      return w[0] ? w[0].toUpperCase() + w.substr(1).toLowerCase() : w;
    }).join(' ');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_keys__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_virtual_scroll_list__ = __webpack_require__(691);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__VuetablePaginationMixin_vue__ = __webpack_require__(201);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__VuetablePaginationInfoMixin_vue__ = __webpack_require__(648);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('ul', {
    ...
    staticClass: "page"
  }, [_vm._v("User accounts")])])], 1), _vm._v(" "), _c('li', {
    staticClass: "pageLink",
    on: {
      "click": _vm.toggleMenu
    }
    ...
    staticClass: "page"
  }, [_vm._v("User groups")])])], 1)])]), _vm._v(" "), _c('li', {
    ...
    staticClass: "page"
  }, [_vm._v("All tables")])])], 1), _vm._v(" "), _c('li', {
    staticClass: "pageLink",
    on: {
      "click": _vm.toggleMenu
    }
  ...
  return _c('a', {
    ...
    staticClass: "fa fa-users"
  }), _vm._v(" "), _c('span', [_vm._v("Users and groups")]), _vm._v(" "), _c('span', {
  ...
  return _c('a', {
    ...
    staticClass: "fas fa-plus"
  }), _vm._v(" "), _c('span', [_vm._v("Data Model")]), _vm._v(" "), _c('span', {
    staticClass: "pull-right-container"
  }, [_c('i', {
  ...
  return _c('div', {
    ...
    return _c('div', {
      ...
      directives: [{
        ...
        rawName: "v-model",
        value: (col.IsUnique),
        expression: "col.IsUnique"
      }],
      attrs: {
        "type": "checkbox"
      },
      domProps: {
        "checked": Array.isArray(col.IsUnique) ? _vm._i(col.IsUnique, null) > -1 : (col.IsUnique)
      },
      on: {
        "change": function($event) {
          var $$a = col.IsUnique,
          ...
          if (Array.isArray($$a)) {
            var $$v = null,
              $$i = _vm._i($$a, $$v);
            if ($$el.checked) {
              $$i < 0 && (col.IsUnique = $$a.concat([$$v]))
            } else {
              $$i > -1 && (col.IsUnique = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
            }
          } else {
            _vm.$set(col, "IsUnique", $$c)
          }
        }
      }
    }), _vm._v(" Unique\n                      ")]), _vm._v(" "), _c('div', {
      ...
      directives: [{
        ...
        rawName: "v-model",
        value: (col.IsIndexed),
        expression: "col.IsIndexed"
      }],
      attrs: {
        "type": "checkbox"
      },
      domProps: {
        "checked": Array.isArray(col.IsIndexed) ? _vm._i(col.IsIndexed, null) > -1 : (col.IsIndexed)
      },
      on: {
        "change": function($event) {
          var $$a = col.IsIndexed,
          ...
          if (Array.isArray($$a)) {
            var $$v = null,
              $$i = _vm._i($$a, $$v);
            if ($$el.checked) {
              $$i < 0 && (col.IsIndexed = $$a.concat([$$v]))
            } else {
              $$i > -1 && (col.IsIndexed = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
            }
          } else {
            _vm.$set(col, "IsIndexed", $$c)
          }
        }
      }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.data.IsAuditEnabled),
      expression: "data.IsAuditEnabled"
    }],
    attrs: {
      "type": "checkbox"
    },
    domProps: {
      "checked": Array.isArray(_vm.data.IsAuditEnabled) ? _vm._i(_vm.data.IsAuditEnabled, null) > -1 : (_vm.data.IsAuditEnabled)
    },
    on: {
      "change": function($event) {
        var $$a = _vm.data.IsAuditEnabled,
          $$el = $event.target,
          $$c = $$el.checked ? (true) : (false);
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.data.IsAuditEnabled = $$a.concat([$$v]))
          } else {
            $$i > -1 && (_vm.data.IsAuditEnabled = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.$set(_vm.data, "IsAuditEnabled", $$c)
        }
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "col-md-3"
  }, [_vm._v("\n              Translations enabled "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.data.TranslationsEnabled),
      expression: "data.TranslationsEnabled"
    }],
    attrs: {
      "type": "checkbox"
    },
    domProps: {
      "checked": Array.isArray(_vm.data.TranslationsEnabled) ? _vm._i(_vm.data.TranslationsEnabled, null) > -1 : (_vm.data.TranslationsEnabled)
    },
    on: {
      "change": function($event) {
        var $$a = _vm.data.TranslationsEnabled,
          $$el = $event.target,
          $$c = $$el.checked ? (true) : (false);
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.data.TranslationsEnabled = $$a.concat([$$v]))
          } else {
            $$i > -1 && (_vm.data.TranslationsEnabled = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.$set(_vm.data, "TranslationsEnabled", $$c)
        }
      }
    }
  })])])])]), _vm._v(" "), _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('aside', {
    ...
    staticClass: "black"
  }, [_vm._v(_vm._s(_vm.user.name))])])])]) : _vm._e(), _vm._v(" "), (!_vm.user) ? _c('div', {
    staticClass: "user-panel"
  }, [_vm._m(0)]) : _vm._e(), _vm._v(" "), _c('sidebar-menu', {
    attrs: {
      "filter": _vm.filter
    }
  })], 1)])
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "box action-form-body"
  ...
  })), _vm._v(" "), (_vm.hasPermissionField && _vm.model.reference_id) ? _c('div', {
    staticClass: "col-md-6"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "change": _vm.setPreferredLanguage
    },
    model: {
      value: (_vm.preferredLanguageLocal),
      callback: function($$v) {
        _vm.preferredLanguageLocal = $$v
      },
      expression: "preferredLanguageLocal"
    }
    ...
    return _c('el-option', {
      ...
      attrs: {
        ...
        "value": language.id,
        "selected": _vm.preferredLanguage === language.id
      }
    })
  }))], 1)]), _vm._v(" "), _c('li', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "breadcrumb"
  }, [(_vm.showSave) ? _c('button', {
    staticClass: "btn btn-warning",
    on: {
      "click": _vm.saveChanges
    }
  }, [_vm._v("Save changes")]) : _vm._e(), _vm._v(" "), _vm._m(0), _vm._v(" "), _vm._l((_vm.$route.meta.breadcrumb), function(crumb) {
    return _c('li', [(crumb.to) ? [_c('router-link', {
      attrs: {
        "to": crumb.to
      }
    ...
    staticClass: "row"
  }, [_c('form', _vm._l((_vm.settings), function(item, name, idx) {
    return (!name.startsWith('encryption')) ? _c('div', {
      key: idx,
      staticClass: "col-md-4",
      staticStyle: {
        "height": "150px"
    ...
    }, [_c('label', [_vm._v(_vm._s(_vm.settingsHelp[name]))]), _vm._v(" "), (item != 'true' && item != 'false') ? _vm._o(_c('input', {
      staticClass: "form-control",
      attrs: {
        "type": "text"
      },
      ...
      on: {
        "change": function($event) {
          _vm.showSaveButton(name, $event.target.value)
        }
      }
    }), 0, idx) : _vm._e(), _vm._v(" "), (item == 'true' || item == 'false') ? _c('div', {
      staticClass: "checkbox"
    }, [_c('label', [_vm._o(_c('input', {
      attrs: {
        "type": "checkbox"
      },
      domProps: {
      ...
      on: {
        "change": function($event) {
          _vm.showSaveButton(name, $event.target.checked)
        }
      }
    }), 1, idx)])]) : _vm._e(), _vm._v(" "), _c('small', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Sign In 2FA")]), _vm._v(" "), _c('router-link', {
    staticClass: "btn bg-blue",
    attrs: {
      "to": {
        name: 'SignUp'
...
//# sourceMappingURL=app.ddebb3f40c40793c0cce.js.map