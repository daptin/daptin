...
var StandardRelations = []api2go.TableRelation{
	...
	api2go.NewTableRelation("oauth_state", "has_one", "oauth_connect"),
	...
	api2go.NewTableRelation("llm_file", "belongs_to", "document"),
	api2go.NewTableRelationWithNames("llm_batch", "llm_batch_id", "belongs_to", "llm_file", "input_file_id"),
	api2go.NewTableRelationWithNames("llm_batch", "llm_batch_id", "has_one", "llm_file", "output_file_id"),
	api2go.NewTableRelation("llm_batch_item", "belongs_to", "llm_batch"),
	...
	api2go.NewTableRelation("contact", "has_one", "address_book"),
...
var StandardTables = []table_info.TableInfo{
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			},
			{
				...
				IsNullable:        false,
				IsIndexed:         false,
				ColumnDescription: "The file system path or URL where the document is stored. Supports paths up to 2048 characters.",
			},
			{
		...
		Columns: []api2go.ColumnInfo{
			{
				...
				DataType:          "varchar(500)",
				IsNullable:        false,
				ColumnDescription: "The canonical CardDAV resource path for this contact.",
			},
			{
				ColumnName:        "content",
				Name:              "content",
				...
				DataType:          "longblob",
				IsNullable:        false,
				ColumnDescription: "The vCard content for this contact.",
			},
		},
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			{
				...
				IsNullable:        false,
				IsIndexed:         true,
				ColumnDescription: "The address-book collection name.",
			},
			{
				...
				DataType:          "text",
				IsNullable:        false,
				ColumnDescription: "A human-readable description of the address book.",
			},
		},
	},
	{
	...
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			},
			{
				...
				DefaultValue:      "false",
				ColumnType:        "truefalse",
				ColumnDescription: "Enables Proof Key for Code Exchange (PKCE) for OAuth providers that require a per-request code challenge and verifier.",
			},
			{
				Name:              "pkce_challenge_method",
				ColumnName:        "pkce_challenge_method",
				DataType:          "varchar(20)",
				DefaultValue:      "'S256'",
				ColumnType:        "label",
				ColumnDescription: "The PKCE challenge method to use when pkce_enabled is true. S256 is the supported and recommended method.",
			},
		},
	},
	{
		...
		DefaultGroups: adminsGroup,
		Columns: []api2go.ColumnInfo{
			{Name: "state_hash", ColumnName: "state_hash", ColumnType: "label", DataType: "varchar(128)", IsUnique: true, IsIndexed: true, IsNullable: false},
			{Name: "code_verifier", ColumnName: "code_verifier", ColumnType: "encrypted", DataType: "varchar(500)", IsNullable: true},
			{Name: "expires_at", ColumnName: "expires_at", ColumnType: "measurement", DataType: "bigint", IsIndexed: true, IsNullable: false},
	...
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			},
			{
				...
				ColumnType:        "json",
				DataType:          "text",
				ColumnDescription: "Reserved JSON configuration for the exchange source.",
			},
			{
				Name:              "source_type",
				...
				ColumnType:        "label",
				DataType:          "varchar(100)",
				ColumnDescription: "The exchange source type. Use 'self' to attach the exchange to a Daptin resource lifecycle.",
			},
			{
				...
				ColumnType:        "json",
				DataType:          "text",
				ColumnDescription: "JSON configuration for the selected action, rest, or gsheet-append target.",
			},
			{
				Name:              "attributes",
				ColumnName:        "attributes",
				ColumnType:        "json",
				DataType:          "text",
				ColumnDescription: "JSON lifecycle configuration containing the source resource name, before or after hook, mutation methods, and optional result mapping.",
			},
			{
				Name:              "target_type",
				...
				ColumnType:        "label",
				DataType:          "varchar(100)",
				ColumnDescription: "The supported destination type: action, rest, or gsheet-append.",
			},
			{
				Name:              "options",
				ColumnName:        "options",
	...
	},
	{
		...
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "name", ColumnName: "name", ColumnType: "label", DataType: "varchar(100)", IsUnique: true, IsIndexed: true,
				ColumnDescription: "Unique provider-account name."},
			{Name: "provider_type", ColumnName: "provider_type", ColumnType: "label", DataType: "varchar(100)", IsNullable: false, IsIndexed: true,
				ColumnDescription: "Registered llmgateway adapter type."},
			{Name: "base_url", ColumnName: "base_url", ColumnType: "url", DataType: "varchar(500)", IsNullable: true,
				ColumnDescription: "Provider API base URL; adapter defaults apply when empty."},
			{
				Name:              "provider_parameters",
				ColumnName:        "provider_parameters",
				ColumnType:        "json",
				DataType:          "text",
				ColumnDescription: "Adapter-specific JSON configuration. The OpenAI-compatible adapter accepts organization, project, and image_generation_path.",
			},
			{Name: "allow_insecure", ColumnName: "allow_insecure", ColumnType: "truefalse", DataType: "bool", DefaultValue: "false", IsNullable: false,
				ColumnDescription: "Explicitly allow HTTP instead of HTTPS for this provider."},
			{Name: "allow_private_network", ColumnName: "allow_private_network", ColumnType: "truefalse", DataType: "bool", DefaultValue: "false", IsNullable: false,
				ColumnDescription: "Explicitly allow loopback, link-local, or private-network provider addresses."},
			{Name: "enable", ColumnName: "enable", ColumnType: "truefalse", DataType: "bool", DefaultValue: "true", IsNullable: false, IsIndexed: true,
				ColumnDescription: "Controls whether this provider account is active."},
		},
	},
	{
		TableName:     "llm_model",
		...
		DefaultGroups: adminsGroup,
		IsHidden:      false,
		Metering: &table_info.MeteringConfig{OnActions: map[string]table_info.MeteringConfig{
			"invoke": {Enabled: true, CostExpr: "1", MeterType: "requests"},
		}},
		Columns: []api2go.ColumnInfo{
			...
			{Name: "capabilities", ColumnName: "capabilities", ColumnType: "json", DataType: "text", DefaultValue: "'{}'",
				ColumnDescription: "Explicit tools, media, structured-output, and sampling capabilities."},
			{Name: "routing_strategy", ColumnName: "routing_strategy", ColumnType: "label", DataType: "varchar(40)", DefaultValue: "'priority_weighted'"},
			{Name: "fallback_models", ColumnName: "fallback_models", ColumnType: "json", DataType: "text", DefaultValue: "'[]'",
				ColumnDescription: "Ordered public-model fallback names."},
			{Name: "default_parameters", ColumnName: "default_parameters", ColumnType: "json", DataType: "text", DefaultValue: "'{}'",
				ColumnDescription: "Operation-scoped default request parameters."},
			{Name: "unsupported_parameter_policy", ColumnName: "unsupported_parameter_policy", ColumnType: "label", DataType: "varchar(20)", DefaultValue: "'reject'"},
			{Name: "enable", ColumnName: "enable", ColumnType: "truefalse", DataType: "bool", DefaultValue: "true", IsNullable: false, IsIndexed: true},
		},
	},
	{
		TableName:     "llm_deployment",
		Icon:          "fa-server",
		DefaultGroups: adminsGroup,
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "name", ColumnName: "name", ColumnType: "label", DataType: "varchar(200)", IsUnique: true, IsIndexed: true},
			{Name: "upstream_model", ColumnName: "upstream_model", ColumnType: "label", DataType: "varchar(300)", IsNullable: false},
			{Name: "operations", ColumnName: "operations", ColumnType: "json", DataType: "text", IsNullable: false},
			{Name: "priority", ColumnName: "priority", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "0", IsIndexed: true},
			{Name: "weight", ColumnName: "weight", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "1"},
			{Name: "request_timeout_ms", ColumnName: "request_timeout_ms", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "90000"},
			{Name: "connect_timeout_ms", ColumnName: "connect_timeout_ms", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "10000"},
			{Name: "max_concurrency", ColumnName: "max_concurrency", ColumnType: "measurement", DataType: "bigint", DefaultValue: "-1"},
			{Name: "rpm", ColumnName: "rpm", ColumnType: "measurement", DataType: "bigint", DefaultValue: "-1"},
			{Name: "tpm", ColumnName: "tpm", ColumnType: "measurement", DataType: "bigint", DefaultValue: "-1"},
			{Name: "pricing", ColumnName: "pricing", ColumnType: "json", DataType: "text", DefaultValue: "'{}'",
				ColumnDescription: "Fixed-point micros-per-million rates keyed by canonical or supplemental usage measure name."},
			{Name: "parameters", ColumnName: "parameters", ColumnType: "json", DataType: "text", DefaultValue: "'{}'",
				ColumnDescription: "Operation-scoped upstream extension fields; canonical request fields cannot be overridden."},
			{Name: "health_check", ColumnName: "health_check", ColumnType: "json", DataType: "text", DefaultValue: "'{}'"},
			{Name: "enable", ColumnName: "enable", ColumnType: "truefalse", DataType: "bool", DefaultValue: "true", IsNullable: false, IsIndexed: true},
		},
	},
	{
	...
	},
	{
		...
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "purpose", ColumnName: "purpose", ColumnType: "label", DataType: "varchar(40)", IsNullable: false, IsIndexed: true,
				ColumnDescription: "OpenAI-compatible purpose; binary content and file metadata remain owned by the related document resource."},
			{Name: "status", ColumnName: "status", ColumnType: "label", DataType: "varchar(30)", DefaultValue: "'processed'", IsNullable: false, IsIndexed: true},
			{Name: "status_details", ColumnName: "status_details", ColumnType: "content", DataType: "text", IsNullable: true},
			{Name: "expires_at", ColumnName: "expires_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true, IsIndexed: true},
		},
	},
	{
		TableName:     "llm_batch",
		...
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "endpoint", ColumnName: "endpoint", ColumnType: "label", DataType: "varchar(100)", IsNullable: false, IsIndexed: true},
			{Name: "completion_window", ColumnName: "completion_window", ColumnType: "label", DataType: "varchar(20)", DefaultValue: "'24h'", IsNullable: false},
			{Name: "status", ColumnName: "status", ColumnType: "label", DataType: "varchar(30)", DefaultValue: "'validating'", IsNullable: false, IsIndexed: true},
			{Name: "metadata", ColumnName: "metadata", ColumnType: "json", DataType: "text", DefaultValue: "'{}'", IsNullable: false},
			{Name: "errors", ColumnName: "errors", ColumnType: "json", DataType: "text", IsNullable: true},
			{Name: "request_counts", ColumnName: "request_counts", ColumnType: "json", DataType: "text", DefaultValue: "'{\"total\":0,\"completed\":0,\"failed\":0}'", IsNullable: false},
			{Name: "output_expiration_seconds", ColumnName: "output_expiration_seconds", ColumnType: "measurement", DataType: "bigint", IsNullable: true},
			{Name: "in_progress_at", ColumnName: "in_progress_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "finalizing_at", ColumnName: "finalizing_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "completed_at", ColumnName: "completed_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "failed_at", ColumnName: "failed_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "expires_at", ColumnName: "expires_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true, IsIndexed: true},
			{Name: "expired_at", ColumnName: "expired_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "cancelling_at", ColumnName: "cancelling_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "cancelled_at", ColumnName: "cancelled_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "claim_expires_at", ColumnName: "claim_expires_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true, IsIndexed: true},
		},
	},
	{
		TableName:     "llm_batch_item",
		Icon:          "fa-list-check",
		DefaultGroups: adminsGroup,
		IsHidden:      true,
		CompositeKeys: [][]string{{"llm_batch_id", "line_number"}, {"llm_batch_id", "custom_id"}},
		Columns: []api2go.ColumnInfo{
			{Name: "line_number", ColumnName: "line_number", ColumnType: "measurement", DataType: "bigint", IsNullable: false, IsIndexed: true},
			{Name: "custom_id", ColumnName: "custom_id", ColumnType: "label", DataType: "varchar(200)", IsNullable: false, IsIndexed: true},
			{Name: "body", ColumnName: "body", ColumnType: "json", DataType: "longtext", IsNullable: false},
			{Name: "status", ColumnName: "status", ColumnType: "label", DataType: "varchar(20)", DefaultValue: "'pending'", IsNullable: false, IsIndexed: true},
			{Name: "response_status", ColumnName: "response_status", ColumnType: "measurement", DataType: "int(11)", IsNullable: true},
			{Name: "response_request_id", ColumnName: "response_request_id", ColumnType: "label", DataType: "varchar(128)", IsNullable: true},
			{Name: "response_body", ColumnName: "response_body", ColumnType: "json", DataType: "longtext", IsNullable: true},
		},
	},
	{
		...
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "status", ColumnName: "status", ColumnType: "label", DataType: "varchar(30)", DefaultValue: "'active'", IsIndexed: true},
			{Name: "period_start", ColumnName: "period_start", ColumnType: "datetime", DataType: "timestamp", DefaultValue: "current_timestamp", IsIndexed: true},
			{Name: "period_end", ColumnName: "period_end", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "metadata", ColumnName: "metadata", ColumnType: "json", DataType: "text", IsNullable: true},
		},
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			{Name: "method", ColumnName: "method", ColumnType: "label", DataType: "varchar(20)"},
			{Name: "entity_type", ColumnName: "entity_type", ColumnType: "label", DataType: "varchar(200)", IsNullable: true, IsIndexed: true},
			{Name: "action_name", ColumnName: "action_name", ColumnType: "label", DataType: "varchar(200)", IsNullable: true, IsIndexed: true},
			{Name: "request_type", ColumnName: "request_type", ColumnType: "label", DataType: "varchar(50)", IsNullable: true, IsIndexed: true},
			{Name: "status_code", ColumnName: "status_code", ColumnType: "measurement", DataType: "int(11)"},
			{Name: "latency_ms", ColumnName: "latency_ms", ColumnType: "measurement", DataType: "int(11)"},
			{Name: "request_bytes", ColumnName: "request_bytes", ColumnType: "measurement", DataType: "int(11)"},
			{Name: "response_bytes", ColumnName: "response_bytes", ColumnType: "measurement", DataType: "int(11)"},
			{Name: "request_body", ColumnName: "request_body", ColumnType: "content", DataType: "longtext", IsNullable: true},
			{Name: "response_body", ColumnName: "response_body", ColumnType: "content", DataType: "longtext", IsNullable: true},
			{Name: "request_body_encoding", ColumnName: "request_body_encoding", ColumnType: "label", DataType: "varchar(10)", IsNullable: true},
			{Name: "response_body_encoding", ColumnName: "response_body_encoding", ColumnType: "label", DataType: "varchar(10)", IsNullable: true},
			{Name: "state", ColumnName: "state", ColumnType: "label", DataType: "varchar(20)", DefaultValue: "'held'", IsIndexed: true},
			{Name: "reservation_expires_at", ColumnName: "reservation_expires_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true, IsIndexed: true},
			{Name: "terminal_at", ColumnName: "terminal_at", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "reserved_measures", ColumnName: "reserved_measures", ColumnType: "json", DataType: "text", DefaultValue: "'{}'", IsNullable: false},
			{Name: "reservation_buckets", ColumnName: "reservation_buckets", ColumnType: "json", DataType: "text", DefaultValue: "'{}'", IsNullable: false},
			{Name: "measures", ColumnName: "measures", ColumnType: "json", DataType: "text", DefaultValue: "'{}'", IsNullable: false},
			{Name: "metadata", ColumnName: "metadata", ColumnType: "json", DataType: "text", IsNullable: true},
			{Name: "error_message", ColumnName: "error_message", ColumnType: "content", DataType: "text", IsNullable: true},
		},
	},
	{
		TableName:     "api_quota",
		...
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "bucket_key", ColumnName: "bucket_key", ColumnType: "label", DataType: "varchar(255)", IsUnique: true, IsIndexed: true},
			{Name: "metric", ColumnName: "metric", ColumnType: "label", DataType: "varchar(100)", IsIndexed: true},
			{Name: "window_start", ColumnName: "window_start", ColumnType: "datetime", DataType: "timestamp", IsIndexed: true},
			{Name: "window_end", ColumnName: "window_end", ColumnType: "datetime", DataType: "timestamp", IsIndexed: true},
			{Name: "maximum", ColumnName: "maximum", ColumnType: "measurement", DataType: "bigint", DefaultValue: "-1"},
			{Name: "reserved", ColumnName: "reserved", ColumnType: "measurement", DataType: "bigint", DefaultValue: "0"},
			{Name: "consumed", ColumnName: "consumed", ColumnType: "measurement", DataType: "bigint", DefaultValue: "0"},
		},
	},
	{
		TableName:     "site",
