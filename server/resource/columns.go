...
var StandardTables = []table_info.TableInfo{
	...
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			{Name: "requests_per_period", ColumnName: "requests_per_period", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "-1"},
			{Name: "compute_units_per_period", ColumnName: "compute_units_per_period", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "-1"},
			{Name: "rate_limit_per_minute", ColumnName: "rate_limit_per_minute", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "-1"},
			{Name: "price_monthly_cents", ColumnName: "price_monthly_cents", ColumnType: "measurement", DataType: "int(11)", IsNullable: true},
			{Name: "overage_price_micros", ColumnName: "overage_price_micros", ColumnType: "measurement", DataType: "int(11)", IsNullable: true},
			{Name: "meter_type", ColumnName: "meter_type", ColumnType: "label", DataType: "varchar(50)", DefaultValue: "'requests'"},
			{Name: "quota_enforce_mode", ColumnName: "quota_enforce_mode", ColumnType: "label", DataType: "varchar(20)", DefaultValue: "'hard'"},
	...
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			{Name: "cost_units", ColumnName: "cost_units", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "0"},
			{Name: "cost_micros", ColumnName: "cost_micros", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "0"},
			{Name: "meter_type", ColumnName: "meter_type", ColumnType: "label", DataType: "varchar(50)", DefaultValue: "'requests'"},
			{Name: "metadata", ColumnName: "metadata", ColumnType: "json", DataType: "text", IsNullable: true},
	...
	},
	{
		...
		IsHidden:      false,
		Columns: []api2go.ColumnInfo{
			{Name: "period_start", ColumnName: "period_start", ColumnType: "datetime", DataType: "timestamp", IsIndexed: true},
			{Name: "period_end", ColumnName: "period_end", ColumnType: "datetime", DataType: "timestamp", IsNullable: true},
			{Name: "request_count", ColumnName: "request_count", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "0"},
			{Name: "compute_units", ColumnName: "compute_units", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "0"},
			{Name: "bytes_used", ColumnName: "bytes_used", ColumnType: "measurement", DataType: "int(11)", DefaultValue: "0"},
		},
	},
	{
		TableName:     "site",
