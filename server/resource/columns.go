...
var StandardRelations = []api2go.TableRelation{
	...
	api2go.NewTableRelation("oauth_code", "belongs_to", "oauth_app"),
	api2go.NewTableRelation("oauth_access", "belongs_to", "oauth_app"),
	api2go.NewTableRelation("oauth_refresh", "belongs_to", "oauth_app"),
...
var SystemActions = []actionresponse.Action{
	...
	},
	{
		...
		InFields: []api2go.ColumnInfo{
			...
			{Name: "redirect_uris", ColumnName: "redirect_uris", ColumnType: "content", IsNullable: false},
			{Name: "scopes", ColumnName: "scopes", ColumnType: "content", IsNullable: true},
			{Name: "grants", ColumnName: "grants", ColumnType: "label", IsNullable: true},
			{Name: "is_confidential", ColumnName: "is_confidential", ColumnType: "truefalse", IsNullable: true},
		},
		OutFields: []actionresponse.Outcome{
			{
				Type:   "oauth.client.register",
				Method: "EXECUTE",
				Attributes: map[string]interface{}{
	...
	{
		Name:             "update_client",
		Label:            "Update OAuth client",
		InstanceOptional: false,
		OnType:           "oauth_app",
		InFields: []api2go.ColumnInfo{
			{Name: "name", ColumnName: "name", ColumnType: "label", IsNullable: true},
			{Name: "redirect_uris", ColumnName: "redirect_uris", ColumnType: "content", IsNullable: true},
			{Name: "scopes", ColumnName: "scopes", ColumnType: "content", IsNullable: true},
			{Name: "grants", ColumnName: "grants", ColumnType: "label", IsNullable: true},
			{Name: "is_confidential", ColumnName: "is_confidential", ColumnType: "truefalse", IsNullable: true},
		},
	...
	},
	{
		...
		Label:            "Rotate OAuth client secret",
		InstanceOptional: false,
		OnType:           "oauth_app",
		InFields:         []api2go.ColumnInfo{},
		OutFields: []actionresponse.Outcome{
			{
				Type:   "oauth.client.rotate_secret",
				Method: "EXECUTE",
				Attributes: map[string]interface{}{
					"subject": "~subject",
					"user":    "~user",
	...
	{
		Name:             "disable_client",
		Label:            "Disable OAuth client",
		InstanceOptional: false,
		OnType:           "oauth_app",
		InFields:         []api2go.ColumnInfo{},
		OutFields: []actionresponse.Outcome{
			{
				Type:   "oauth.client.disable",
				Method: "EXECUTE",
				Attributes: map[string]interface{}{
					"subject": "~subject",
					"user":    "~user",
	...
	{
		Name:             "enable_client",
		Label:            "Enable OAuth client",
		InstanceOptional: false,
		OnType:           "oauth_app",
		InFields:         []api2go.ColumnInfo{},
		OutFields: []actionresponse.Outcome{
			{
				Type:   "oauth.client.enable",
				Method: "EXECUTE",
				Attributes: map[string]interface{}{
					"subject": "~subject",
					"user":    "~user",
	...
	{
		Name:             "revoke_client_tokens",
		Label:            "Revoke OAuth client tokens",
		InstanceOptional: false,
		OnType:           "oauth_app",
		InFields:         []api2go.ColumnInfo{},
		OutFields: []actionresponse.Outcome{
			{
				Type:   "oauth.client.revoke_tokens",
				Method: "EXECUTE",
				Attributes: map[string]interface{}{
					"subject": "~subject",
					"user":    "~user",
...
var StandardTables = []table_info.TableInfo{
	...
	},
	{
		...
		DefaultGroups: adminsGroup,
		Columns: []api2go.ColumnInfo{
			{Name: "name", ColumnName: "name", ColumnType: "label", DataType: "varchar(150)", IsUnique: true, IsIndexed: true},
			{Name: "client_id", ColumnName: "client_id", ColumnType: "label", DataType: "varchar(200)", IsUnique: true, IsIndexed: true},
			{Name: "client_secret", ColumnName: "client_secret", ColumnType: "password", DataType: "varchar(500)", IsNullable: true},
			{Name: "redirect_uris", ColumnName: "redirect_uris", ColumnType: "content", DataType: "text"},
			{Name: "scopes", ColumnName: "scopes", ColumnType: "content", DataType: "text", DefaultValue: "'openid profile email'"},
			{Name: "grants", ColumnName: "grants", ColumnType: "label", DataType: "varchar(300)", DefaultValue: "'authorization_code,refresh_token'"},
			{Name: "is_confidential", ColumnName: "is_confidential", ColumnType: "truefalse", DataType: "bool", DefaultValue: "true"},
			{Name: "is_enabled", ColumnName: "is_enabled", ColumnType: "truefalse", DataType: "bool", DefaultValue: "true"},
		},
	},
	{
		...
		DefaultGroups: adminsGroup,
		Columns: []api2go.ColumnInfo{
			{Name: "code_hash", ColumnName: "code_hash", ColumnType: "label", DataType: "varchar(128)", IsUnique: true, IsIndexed: true, IsNullable: false},
			{Name: "redirect_uri", ColumnName: "redirect_uri", ColumnType: "url", DataType: "text"},
			{Name: "scope", ColumnName: "scope", ColumnType: "content", DataType: "text"},
			...
			{Name: "code_challenge", ColumnName: "code_challenge", ColumnType: "label", DataType: "varchar(200)", IsNullable: true},
			{Name: "code_challenge_method", ColumnName: "code_challenge_method", ColumnType: "label", DataType: "varchar(20)", IsNullable: true},
			{Name: "nonce", ColumnName: "nonce", ColumnType: "label", DataType: "varchar(200)", IsNullable: true},
		},
	},
	{
		...
		DefaultGroups: adminsGroup,
		Columns: []api2go.ColumnInfo{
			{Name: "token_hash", ColumnName: "token_hash", ColumnType: "label", DataType: "varchar(128)", IsUnique: true, IsIndexed: true},
			{Name: "token_type", ColumnName: "token_type", ColumnType: "label", DataType: "varchar(40)", DefaultValue: "'Bearer'"},
			{Name: "scope", ColumnName: "scope", ColumnType: "content", DataType: "text"},
			{Name: "expires_at", ColumnName: "expires_at", ColumnType: "measurement", DataType: "bigint"},
			{Name: "revoked_at", ColumnName: "revoked_at", ColumnType: "measurement", DataType: "bigint", IsNullable: true},
		},
	},
	{
		TableName:     "oauth_refresh",
		IsHidden:      true,
		Icon:          "fa-redo",
		DefaultGroups: adminsGroup,
		Columns: []api2go.ColumnInfo{
	...
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			{Name: "scope", ColumnName: "scope", ColumnType: "content", DataType: "text"},
			{Name: "granted_at", ColumnName: "granted_at", ColumnType: "measurement", DataType: "bigint"},
			{Name: "revoked_at", ColumnName: "revoked_at", ColumnType: "measurement", DataType: "bigint", IsNullable: true},
		},
	},
	{
		...
		DefaultGroups: adminsGroup,
		Columns: []api2go.ColumnInfo{
			{Name: "key_id", ColumnName: "key_id", ColumnType: "label", DataType: "varchar(120)", IsUnique: true, IsIndexed: true},
			{Name: "algorithm", ColumnName: "algorithm", ColumnType: "label", DataType: "varchar(40)", DefaultValue: "'RS256'"},
			{Name: "public_key", ColumnName: "public_key", ColumnType: "content", DataType: "text", IsNullable: true},
			{Name: "private_key", ColumnName: "private_key", ColumnType: "encrypted", DataType: "text", IsNullable: true},
			{Name: "is_active", ColumnName: "is_active", ColumnType: "truefalse", DataType: "bool", DefaultValue: "true"},
		},
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			{
				...
				IsUnique:          true,
				IsIndexed:         true,
				ColumnDescription: "Unique identifier for this LLM provider configuration.",
			},
			{
				Name:              "provider_type",
				...
				DataType:          "varchar(100)",
				IsNullable:        false,
				ColumnDescription: "The LLM provider backend: openai, anthropic, gemini, ollama, groq, bedrock, azure, deepseek, mistral, or any openai-compatible.",
			},
			{
				Name:              "base_url",
				ColumnName:        "base_url",
				...
				DataType:          "varchar(500)",
				IsNullable:        true,
				ColumnDescription: "Custom API base URL. If empty, uses provider default. Required for ollama, azure, and custom openai-compatible endpoints.",
			},
			{
				Name:              "models",
				ColumnName:        "models",
				...
				DataType:          "text",
				IsNullable:        false,
				ColumnDescription: "Comma-separated list of model names this provider handles. Used for model-to-provider routing.",
			},
			{
				Name:              "credential_name",
				ColumnName:        "credential_name",
				...
				IsNullable:        true,
				DataType:          "varchar(1000)",
				ColumnDescription: "References the name of a credential record containing the API key. Null for providers that don't require auth (e.g. local ollama).",
			},
			{
				Name:              "provider_parameters",
				ColumnName:        "provider_parameters",
				ColumnType:        "json",
				DataType:          "text",
				ColumnDescription: "JSON with provider-specific defaults: anthropic_version, api_version (azure), organization (openai), default temperature, max_tokens, etc.",
			},
			{
				Name:              "model_pricing",
				ColumnName:        "model_pricing",
				ColumnType:        "json",
				DataType:          "text",
				IsNullable:        true,
				ColumnDescription: "JSON pricing per model in USD per million tokens. Format: {\"model-name\": {\"input\": 2.50, \"output\": 10.00, \"cache_read\": 0.25, \"cache_write\": 3.75}}. Used for cost tracking in llm_usage.",
			},
			{
				Name:              "enable",
				ColumnName:        "enable",
				...
				DefaultValue:      "true",
				IsNullable:        false,
				ColumnDescription: "Controls whether this provider is active. Disabled providers are skipped during model routing.",
			},
		},
	},
	{
		...
		Columns: []api2go.ColumnInfo{
			...
			},
			{
				...
				ColumnType: "label",
				DataType:   "varchar(20)",
				ColumnDescription: "chat, completion, or embedding",
			},
			{
				Name:       "input_tokens",
			...
			},
			{
				...
				ColumnName: "cache_read_tokens",
				ColumnType: "measurement",
				DataType:   "int(11)",
			},
			{
				Name:       "cache_write_tokens",
				ColumnName: "cache_write_tokens",
				ColumnType: "measurement",
				DataType:   "int(11)",
			},
			{
				Name:       "reasoning_tokens",
				ColumnName: "reasoning_tokens",
				ColumnType: "measurement",
				DataType:   "int(11)",
			},
			{
			...
			{
				Name:              "cost_micros",
				ColumnName:        "cost_micros",
				ColumnType:        "measurement",
				DataType:          "int(11)",
				ColumnDescription: "Cost in 1/1,000,000 USD. Divide by 1,000,000 for USD. Avoids float precision issues.",
			},
			{
				Name:       "duration_ms",
