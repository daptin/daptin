...
func (c *ConfigStore) GetConfigValueFor(key string, configtype string) string {
	var val string
	...
	CheckErr(err, "Failed to scan config value")
	return val
}
...
func (c *ConfigStore) SetConfigValueFor(key string, val string, configtype string) {
